    ...
    a.fn.slide = function (b) {
        return a.fn.slide.defaults = {
            ...
            if (m >= u) {
                ...
                switch (e) {
                    case"fold":
                        l.css({position: "relative", /*width: 100%,*/ height: C}).children().css({
                            display: "none"
                        });
                        break;
                    case"top":
                        l.wrap('<div class="tempWrap" style="margin:0 auto;overflow:hidden; position:relative; height:' + u * C + 'px"></div>').css({
                            top: -(p * t) * C,
                            position: "relative",
                            padding: "0",
                            margin: "0"
                        ...
                        break;
                    case"left":
                        l.wrap('<div class="tempWrap" style="margin:0 auto;overflow:hidden; position:relative; width:' + u * D + 'px"></div>').css({
                            width: m * D,
                            left: -(p * t) * D,
                            position: "relative",
                            overflow: "hidden",
                    ...
                    case"leftLoop":
                    case"leftMarquee":
                        Z(), l.wrap('<div class="tempWrap" style="margin:0 auto;overflow:hidden; position:relative; width:' + u * D + 'px"></div>').css({
                            width: (m + u + P) * D,
                            position: "relative",
                            overflow: "hidden",
                            padding: "0",
                    ...
                    case"topLoop":
                    case"topMarquee":
                        Z(), l.wrap('<div class="tempWrap" style="margin:0 auto;overflow:hidden; position:relative; height:' + u * C + 'px"></div>').css({
                            height: (m + u + P) * C,
                            position: "relative",
                            padding: "0",
                            margin: "0",
